...
export function generateBookingEmail(booking: any): string {
  return `
    ...
    <head>
      ...
      <title>Booking Confirmation - Phoenix Ethiopia Tours</title>
    </head>
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto;">
      <div style="background: linear-gradient(135deg, #059669 0%, #7c3aed 100%); padding: 30px; color: white; text-align: center;">
        ...
        <p style="opacity: 0.9; margin: 10px 0 0;">Thank you for choosing Phoenix Ethiopia Tours</p>
      </div>
      ...
      <div style="padding: 30px; background: #f9fafb;">
        ...
        <div style="text-align: center; padding: 20px; background: #dcfce7; border-radius: 8px;">
          ...
          <p style="margin: 5px 0 0; color: #065f46;">or email: contact@phoenixethiopiatours.com</p>
        </div>
      </div>
    </body>
    </html>
